...
from test_framework.test_framework import AmbankCoinTier2TestFramework
...
class MasternodeGovernanceBasicTest(AmbankCoinTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.ambankcoin.com/t/test-proposal"
