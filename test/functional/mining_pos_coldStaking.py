...
from test_framework.ambankcoin_node import AmbankCoinTestNode
...
class AMBANKCOIN_ColdStakingTest(AmbankCoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(AmbankCoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 AMBK from the pot)
...
if __name__ == '__main__':
    AMBANKCOIN_ColdStakingTest().main()
