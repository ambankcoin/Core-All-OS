...
class ListReceivedTest (AmbankCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 AMBK.
        ...
        # Send 1 AMBK to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 AMBK sending them all (fee is 0.1 AMBK)
        ...
        # Confirm transaction (2 AMBK from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 AMBK, send 0.6 AMBK + 0.05 AMBK fee
