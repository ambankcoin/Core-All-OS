...
"""Verify that starting ambankcoin with -h works as expected."""
import subprocess

from test_framework.test_framework import AmbankCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(AmbankCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ambankcoin with -? for help text")
        ...
        self.log.info("Start ambankcoin with -version for version information")
