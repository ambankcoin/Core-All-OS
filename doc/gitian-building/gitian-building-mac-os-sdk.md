...
The script [extract-osx-sdk.sh](https://github.com/ambankcoin/Core-All-OS/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
ambankcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/ambankcoin/Core-All-OS/blob/master/doc/README_osx.md) for troubleshooting tips.