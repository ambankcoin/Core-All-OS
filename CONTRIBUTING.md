Contributing to AMBANKCOIN Core
============================

The AMBANKCOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ambankcoin-project/ambankcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the AMBANKCOIN Core project, and is not to be
confused with overall AMBANKCOIN Network Protocol consensus changes.

Whether a pull request is merged into AMBANKCOIN Core rests with the project merge
...
Where a patchset proposes to change the AMBANKCOIN consensus, it must have been
...
The project leader is the release manager for each AMBANKCOIN Core release.
