...
// Copyright (c) 2015-2018 The AMBANKCOIN developers
...
/* AmbankCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AMBANKCOIN"
#define QAPP_ORG_DOMAIN "ambankcoin.com"
#define QAPP_APP_NAME_DEFAULT "AMBANKCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "AMBANKCOIN-Qt-testnet"
