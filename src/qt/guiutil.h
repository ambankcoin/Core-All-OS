...
/** Utility functions used by the AMBANKCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render AMBANKCOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZambk = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZambk = false);
...
// Parse "ambankcoin:" URI into recipient object, return true on successful parsing
