...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            AMBANKCOINGUI* window = static_cast<AMBANKCOINGUI*>(parentWidget());
...
{
    AMBANKCOINGUI* gui = static_cast<AMBANKCOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<AMBANKCOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("AMBANKCOIN will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your AMBKs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
