...
#include "qt/ambankcoin/forms/ui_masternodewizarddialog.h"

#include "activemasternode.h"
#include "optionsmodel.h"
#include "pairresult.h"
#include "qt/ambankcoin/mnmodel.h"
    ...
    walletModel(model)
{
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("34005");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("34003");
    } else {
        ui->lineEditPort->setText("34001");
    }
