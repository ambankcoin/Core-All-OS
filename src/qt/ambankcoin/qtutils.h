...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, AMBANKCOINGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, AMBANKCOINGUI* gui, double posX = 3);
