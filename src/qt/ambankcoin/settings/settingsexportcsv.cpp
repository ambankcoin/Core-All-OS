...
#include "qt/ambankcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(AMBANKCOINGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("AMBANKCOIN_tx_csv_export(*.csv)") : tr("AMBANKCOIN_addresses_csv_export(*.csv)"),
                                        nullptr);
