...
#include "qt/ambankcoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/ambankcoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(AMBANKCOINGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableAMBK,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableAMBK,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableAMBK,
    ...
    connect(ui->pushButton_UnspendableAMBK, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableAMBK);});
    ...
    if (parent)
        connect(parent, &AMBANKCOINGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
