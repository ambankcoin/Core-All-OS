...
#include "qt/ambankcoin/settings/settingsnetworkwidget.h"
#include "qt/ambankcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ambankcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(AMBANKCOINGUI* _window, QWidget *parent) :
