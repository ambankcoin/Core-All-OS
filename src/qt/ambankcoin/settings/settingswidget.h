...
#include <QWidget>
#include "qt/ambankcoin/pwidget.h"
#include "qt/ambankcoin/settings/settingsbackupwallet.h"
#include "qt/ambankcoin/settings/settingsexportcsv.h"
#include "qt/ambankcoin/settings/settingsbittoolwidget.h"
#include "qt/ambankcoin/settings/settingssignmessagewidgets.h"
#include "qt/ambankcoin/settings/settingswalletrepairwidget.h"
#include "qt/ambankcoin/settings/settingswalletoptionswidget.h"
#include "qt/ambankcoin/settings/settingsmainoptionswidget.h"
#include "qt/ambankcoin/settings/settingsdisplayoptionswidget.h"
#include "qt/ambankcoin/settings/settingsmultisendwidget.h"
#include "qt/ambankcoin/settings/settingsinformationwidget.h"
...
public:
    explicit SettingsWidget(AMBANKCOINGUI* parent);
    ~SettingsWidget();
