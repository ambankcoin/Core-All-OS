...
#include "qt/ambankcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ambankcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(AMBANKCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to AMBANKCOINGUI::handleRestart()
