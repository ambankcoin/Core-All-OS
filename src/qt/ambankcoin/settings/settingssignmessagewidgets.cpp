...
#include "qt/ambankcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(AMBANKCOINGUI* _window, QWidget *parent) :
