...
#include "config/ambankcoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalAmbk = 0;
    qint64 totalZambk = 0;
    QList<qreal> valuesAmbk;
    QList<qreal> valueszAmbk;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(AMBANKCOINGUI* _window);
    ~DashboardWidget();
