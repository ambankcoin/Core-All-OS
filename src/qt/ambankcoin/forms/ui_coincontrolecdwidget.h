/********************************************************************************
** Form generated from reading UI file 'coincontrolambkwidget.ui'
**
...
#ifndef UI_COINCONTROLAMBKWIDGET_H
#define UI_COINCONTROLAMBKWIDGET_H
...
class Ui_CoinControlAmbkWidget
{
public:
    ...
    void setupUi(QWidget *CoinControlAmbkWidget)
    {
        if (CoinControlAmbkWidget->objectName().isEmpty())
            CoinControlAmbkWidget->setObjectName(QStringLiteral("CoinControlAmbkWidget"));
        CoinControlAmbkWidget->resize(918, 552);
        CoinControlAmbkWidget->setStyleSheet(QStringLiteral(""));
        verticalLayout_2 = new QVBoxLayout(CoinControlAmbkWidget);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        frameContainer = new QFrame(CoinControlAmbkWidget);
        ...
        retranslateUi(CoinControlAmbkWidget);

        QMetaObject::connectSlotsByName(CoinControlAmbkWidget);
    } // setupUi

    void retranslateUi(QWidget *CoinControlAmbkWidget)
    {
        CoinControlAmbkWidget->setWindowTitle(QApplication::translate("CoinControlAmbkWidget", "Dialog", Q_NULLPTR));
        labelTitle->setText(QApplication::translate("CoinControlAmbkWidget", "Transaction Details", Q_NULLPTR));
        btnEsc->setText(QApplication::translate("CoinControlAmbkWidget", "PushButton", Q_NULLPTR));
        labelTitleAmount->setText(QApplication::translate("CoinControlAmbkWidget", "AMBK:", Q_NULLPTR));
        labelValueAmount->setText(QApplication::translate("CoinControlAmbkWidget", "TextLabel", Q_NULLPTR));
        labelTitleQuantity->setText(QApplication::translate("CoinControlAmbkWidget", "Quantity:", Q_NULLPTR));
        labelValueQuantity->setText(QApplication::translate("CoinControlAmbkWidget", "TextLabel", Q_NULLPTR));
        labelTitleFee->setText(QApplication::translate("CoinControlAmbkWidget", "Fee:", Q_NULLPTR));
        labelValueFee->setText(QApplication::translate("CoinControlAmbkWidget", "TextLabel", Q_NULLPTR));
        labelTitleDenom->setText(QApplication::translate("CoinControlAmbkWidget", "Amount", Q_NULLPTR));
        labelTitleId->setText(QApplication::translate("CoinControlAmbkWidget", "Label", Q_NULLPTR));
        labelTitleVersion->setText(QApplication::translate("CoinControlAmbkWidget", "Address", Q_NULLPTR));
        labelTitleType->setText(QApplication::translate("CoinControlAmbkWidget", "Type", Q_NULLPTR));
        labelTitleSpen->setText(QApplication::translate("CoinControlAmbkWidget", "Date", Q_NULLPTR));
        labelTitleConfirmations->setText(QApplication::translate("CoinControlAmbkWidget", "Confirmations", Q_NULLPTR));
        checkBoxAll->setText(QApplication::translate("CoinControlAmbkWidget", "CheckBox", Q_NULLPTR));
        labelTitleBytes->setText(QApplication::translate("CoinControlAmbkWidget", "Bytes:", Q_NULLPTR));
        labelValueBytes->setText(QApplication::translate("CoinControlAmbkWidget", "TextLabel", Q_NULLPTR));
        labelTitleDust->setText(QApplication::translate("CoinControlAmbkWidget", "Dust:", Q_NULLPTR));
        labelValueDust->setText(QApplication::translate("CoinControlAmbkWidget", "TextLabel", Q_NULLPTR));
        labelTitleChange->setText(QApplication::translate("CoinControlAmbkWidget", "Change:", Q_NULLPTR));
        labelValueChange->setText(QApplication::translate("CoinControlAmbkWidget", "TextLabel", Q_NULLPTR));
        labelTitleAfter->setText(QApplication::translate("CoinControlAmbkWidget", "After Fee: ", Q_NULLPTR));
        labelValueAfter->setText(QApplication::translate("CoinControlAmbkWidget", "TextLabel", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("CoinControlAmbkWidget", "CANCEL", Q_NULLPTR));
        btnSave->setText(QApplication::translate("CoinControlAmbkWidget", "OK", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class CoinControlAmbkWidget: public Ui_CoinControlAmbkWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_COINCONTROLAMBKWIDGET_H
