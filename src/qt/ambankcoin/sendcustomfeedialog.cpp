...
#include "qt/ambankcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(AMBANKCOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &AMBANKCOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
