...
#include "qt/ambankcoin/topbar.h"
#include "qt/ambankcoin/forms/ui_topbar.h"
#include "qt/ambankcoin/lockunlock.h"
#include "qt/ambankcoin/qtutils.h"
#include "qt/ambankcoin/receivedialog.h"
#include "qt/ambankcoin/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/ambankcoin/balancebubble.h"
...
TopBar::TopBar(AMBANKCOINGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopAmbk, ui->labelAmountTopShieldedAmbk}, "amount-small-topbar");
    setCssProperty({ui->labelAmountAmbk}, "amount-topbar");
    setCssProperty({ui->labelPendingAmbk, ui->labelImmatureAmbk}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("AMBANKCOIN")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // AMBK Total
    QString totalAmbk = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // AMBK
    // Top
    ui->labelAmountTopAmbk->setText(totalTransparent);
    ui->labelAmountTopShieldedAmbk->setText(totalShielded);
    // Expanded
    ui->labelAmountAmbk->setText(totalAmbk);
    ui->labelPendingAmbk->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureAmbk->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
