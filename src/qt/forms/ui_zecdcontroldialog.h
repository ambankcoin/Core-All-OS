/********************************************************************************
** Form generated from reading UI file 'zambkcontroldialog.ui'
**
...
#ifndef UI_ZAMBKCONTROLDIALOG_H
#define UI_ZAMBKCONTROLDIALOG_H
...
public:
    ...
    void setupUi(QDialog *ZAmbkControlDialog)
    {
        if (ZAmbkControlDialog->objectName().isEmpty())
            ZAmbkControlDialog->setObjectName(QStringLiteral("ZAmbkControlDialog"));
        ZAmbkControlDialog->resize(681, 550);
        ZAmbkControlDialog->setMinimumSize(QSize(681, 550));
        verticalLayout_1 = new QVBoxLayout(ZAmbkControlDialog);
        ...
        frame = new QFrame(ZAmbkControlDialog);
        ...
        labelZAmbk = new QLabel(layoutAmount);
        labelZAmbk->setObjectName(QStringLiteral("labelZAmbk"));

        horizontalLayout_9->addWidget(labelZAmbk);

        labelZAmbk_int = new QLabel(layoutAmount);
        labelZAmbk_int->setObjectName(QStringLiteral("labelZAmbk_int"));

        horizontalLayout_9->addWidget(labelZAmbk_int);
        ...
        __qtreewidgetitem->setText(3, QStringLiteral("zAMBK Version"));
        __qtreewidgetitem->setText(2, QStringLiteral("zAMBK ID"));
        ...
        retranslateUi(ZAmbkControlDialog);
        QObject::connect(buttonBox, SIGNAL(accepted()), ZAmbkControlDialog, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), ZAmbkControlDialog, SLOT(reject()));

        QMetaObject::connectSlotsByName(ZAmbkControlDialog);
    } // setupUi

    void retranslateUi(QDialog *ZAmbkControlDialog)
    {
        ZAmbkControlDialog->setWindowTitle(QApplication::translate("ZAmbkControlDialog", "Select zAMBK to Spend", Q_NULLPTR));
        labelTitle->setText(QApplication::translate("ZAmbkControlDialog", "Coin Control", Q_NULLPTR));
        btnEsc->setText(QApplication::translate("ZAmbkControlDialog", "PushButton", Q_NULLPTR));
        labelZAmbk->setText(QApplication::translate("ZAmbkControlDialog", "zAmbk", Q_NULLPTR));
        labelZAmbk_int->setText(QApplication::translate("ZAmbkControlDialog", "0.00 ", Q_NULLPTR));
        labelQuantity->setText(QApplication::translate("ZAmbkControlDialog", "Quantity:", Q_NULLPTR));
        labelQuantity_int->setText(QApplication::translate("ZAmbkControlDialog", "0", Q_NULLPTR));
        pushButtonAll->setText(QApplication::translate("ZAmbkControlDialog", "Select/Deselect All", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem = treeWidget->headerItem();
        ___qtreewidgetitem->setText(5, QApplication::translate("ZAmbkControlDialog", "Is Spendable", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class ZAmbkControlDialog: public Ui_ZAmbkControlDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ZAMBKCONTROLDIALOG_H
