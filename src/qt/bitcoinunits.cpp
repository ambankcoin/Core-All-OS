...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(AMBK);
    unitlist.append(mAMBK);
    unitlist.append(uAMBK);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case AMBK:
        return QString("ambankcoin");
    case mAMBK:
        return QString("mambankcoin");
    case uAMBK:
        return QString::fromUtf8("uambankcoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZAMBK)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZAMBK);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZAMBK)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZAMBK));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
