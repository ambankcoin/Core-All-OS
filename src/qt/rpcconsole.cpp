                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzAMBKPathCustom = GetArg("-zambkbackuppath", "");
    ...
    if(!strzAMBKPathCustom.empty()) {
        ui->wallet_customzambkbackuppath->setText(QString::fromStdString(strzAMBKPathCustom));
        ui->wallet_customzambkbackuppath_label->setVisible(true);
        ui->wallet_customzambkbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzAMBKPathCustom.empty()) && nCustomBackupThreshold > 0) {
