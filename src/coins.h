...
public:
    ...
    /**
     * Amount of ambankcoin coming in to a transaction
...
// AMBANKCOIN: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
