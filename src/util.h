...
extern const char * const AMBANKCOIN_CONF_FILENAME;
extern const char * const AMBANKCOIN_PID_FILENAME;
extern const char * const AMBANKCOIN_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("ambankcoin-%s", name);
