...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("AmbankCoin Core ambankcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ambankcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ambankcoin transaction") + "\n" +
                               "  ambankcoin-tx [options] -create [commands]   " + _("Create hex-encoded ambankcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ambankcoin transaction
