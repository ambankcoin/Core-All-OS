...
#define BOOST_TEST_MODULE AmbankCoin Test Suite
...
{
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_ambankcoin_%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(100000)));
